...
python submitOnTier3.py --filelist filelist/TauTo3Mu_TuneCP5_14TeV-pythia8_TDR_PU200.txt  --tag TauTo3Mu_TuneCP5_14TeV-pythia8_TDR_PU200_${SUFFIX_TAG} --save-tau-3mu --all-gen-mu  --only-mu-from-tau  --njobs 25 --no-tar --no-xrdcp-tar  --tar-suffix $SUFFIX_TAG