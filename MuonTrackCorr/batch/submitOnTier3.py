...
if not args.xrdcptaronly:
    ...
    for n in range(0, njobs):
        ...
        theCmd = 'cmsRun %s inputFiles_load=%s outputFile=%s promptMuOnly=%i muFromTausOnly=%i saveTauTo3Mu=%i' % (cmsRunExec, outListNameBare, outputFileName, (0 if args.allgenmu else 1), (1 if args.mufromtauonly else 0), (1 if args.savetau3mu else 0))
