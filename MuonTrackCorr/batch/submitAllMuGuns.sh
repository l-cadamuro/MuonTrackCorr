SUFFIX_TAG="24Sett_TDR_MC_EMTFmode_FixCppFlag_SvenTPFix_BarrOvrl_v3"
...
python submitOnTier3.py --filelist filelist/Mu_FlatPt2to100_gun_PU300_TDR_MC.txt      --tag MuMu_flatPt_300PU_${SUFFIX_TAG}    --njobs 1000 --no-tar --no-xrdcp-tar --tar-suffix $SUFFIX_TAG
