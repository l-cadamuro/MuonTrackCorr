...
** update 4/11/2019: added handling of central value to improve relaxation
*/
...
void MatchWindow::SetCentral(std::string formula)
{
    TF1 f ("tmp", formula.c_str(), 0, 1000);
    SetCentral(&f);
}
...
void MatchWindow::SetCentral(TF1* formula)
{
    if (f_cent)
